 ...
 */
let nameInCaps = "Jonathan"
let lowercaseName = "jonathan"
 ...
 */
if nameInCaps == lowercaseName {
    print("The two strings are equal.")
} else {
    print("The two strings are not equal.")
}

if nameInCaps.lowercased() == lowercaseName.lowercased() {
    print("\(nameInCaps.lowercased()) and \(lowercaseName.lowercased()) are the same.")
} else {
    print("\(nameInCaps.lowercased()) and \(lowercaseName.lowercased()) are not the same")
}
...
if textToSearchFor.lowercased().contains(textToSearchFor.lowercased()) {
    print("I Found it!")
}
//:  Print to the console the number of characters in your name by using the `count` property on `name`.
let name = "Jonathan Guzman"
print("The number of characters in my name is \(name.count).")
