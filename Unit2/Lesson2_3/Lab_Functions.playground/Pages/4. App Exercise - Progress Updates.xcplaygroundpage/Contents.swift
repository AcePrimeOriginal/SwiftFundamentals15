...
func pacing(currentDistance: Double, totalDisctance: Double, currentTime: Double, goalTime: Double) {
    let expectedTime = (currentTime / currentDistance) * totalDisctance
