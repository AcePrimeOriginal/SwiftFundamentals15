...
let favoriteBook = Book(title: "Ace of Spades", author: "Faridah", pages: 418, price: 12.99)
print("\(favoriteBook.title) by \(favoriteBook.author), \(favoriteBook.pages) pages, $\(favoriteBook.price)")
/*:
...
struct Laptop {
    ...
    var repaireCount: Int = 0
    var yearPurchased: Int
}

let laptop1 = Laptop(yearPurchased: 2020)
let laptop2 = Laptop(screenSize: 15, repirCount: 2, yearPurchased: 2022)
/*:
