...
print(RunningWorkout.mileTimeFor(distance: 5000, time: 20))
print("Meters to feet: \(RunningWorkout.meterInFeet), Mile to meters: \(RunningWorkout.mileInMeters)"
/*:
...
var mySteps = Steps(steps: 9999, goal: 100000)
      mySteps.takeStep()
/*:
